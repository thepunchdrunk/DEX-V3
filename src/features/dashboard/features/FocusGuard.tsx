        ...
        return (
            <div className={`p-5 rounded-2xl bg-white border border-neutral-200 hover:shadow-md transition-colors ${className}`}>
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h3 className="font-bold text-neutral-900">Focus Guard</h3>
                        <p className="text-xs text-neutral-500">Deep work patterns</p>
                    </div>
                    <div className={`ml-auto px-2 py-1 rounded text-xs font-bold ${getDeepWorkColor(metrics.deepWorkPercentage)} bg-neutral-50`}>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="p-3 bg-neutral-50 rounded-lg">
                        <span className="block text-xs text-neutral-500 mb-1">Longest Block</span>
                        <span className="block text-lg font-bold text-neutral-900">{metrics.longestFocusBlock}m</span>
                    </div>
                    <div className="p-3 bg-neutral-50 rounded-lg">
                        <span className="block text-xs text-neutral-500 mb-1">Switching</span>
    ...
    return (
        <div className={`space-y-4 ${className}`}>
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="text-xl font-bold text-neutral-900">Focus Guard</h2>
                    <p className="text-sm text-neutral-500">Your deep work patterns this week</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 overflow-hidden shadow-sm">
                ...
                <div className="p-5 grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-sm text-neutral-500">Deep Work Time</span>
                    ...
                    <div className="p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-neutral-500">Context Switches</span>
                        </div>
                    ...
                    <div className="p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-neutral-500">Longest Focus</span>
                        </div>
                        <p className={`text-xl font-bold ${metrics.longestFocusBlock >= 90 ? 'text-[#4CAF50]' : 'text-neutral-900'
                            }`}>
                    ...
                    <div className="p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-neutral-500">Fragmented Days</span>
                        </div>
                    ...
                    <div className="p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-neutral-500">Suggestion</span>
                        </div>
                ...
                {metrics.alerts.length > 0 && (
                    <div className="px-5 pb-5">
                        <h4 className="text-sm font-medium text-neutral-500 mb-3">Insights</h4>
