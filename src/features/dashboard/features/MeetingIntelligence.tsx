...
const MeetingIntelligence: React.FC<MeetingIntelligenceProps & { viewMode?: 'FULL' | 'WIDGET' }> = ({ className = '', viewMode = 'FULL' }) => {
    ...
    if (viewMode === 'WIDGET') {
        return (
            <div className={`p-5 rounded-2xl bg-white border border-neutral-200 hover:shadow-md transition-colors ${className}`}>
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center">
                        <Calendar className="w-5 h-5 text-white" />
                    </div>
                    <div>
                        <h3 className="font-bold text-neutral-900">Meeting Load</h3>
                        <p className="text-xs text-neutral-500">Total hours this week</p>
                    </div>
                ...
                <div className="space-y-4">
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <span className="text-neutral-500">Total Load</span>
                            <span className="text-neutral-900 font-medium">{pattern.totalHours}h / 40h</span>
                        </div>
                    ...
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <span className="text-neutral-500">Focus Time</span>
                            <span className="text-neutral-900 font-medium">{focusTimePercent}%</span>
                        </div>
                        <div className="h-2 bg-[#E0E0E0] rounded-full overflow-hidden">
                            <div
    ...
    return (
        <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="text-xl font-bold text-neutral-900">Meeting Intelligence</h2>
                    <p className="text-sm text-neutral-500">Your calendar patterns this week</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white rounded-2xl p-4 border border-neutral-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-neutral-500">Total Hours</span>
                    </div>
                    <p className="text-2xl font-bold text-neutral-900">{pattern.totalHours}h</p>
                    <p className="text-xs text-neutral-400">of 40h work week</p>
                </div>

                <div className="bg-white rounded-2xl p-4 border border-neutral-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                        <Users className="w-4 h-4 text-purple-600" />
                        <span className="text-sm text-neutral-500">Meetings</span>
                    </div>
                    <p className="text-2xl font-bold text-neutral-900">{pattern.meetingsCount}</p>
                ...
                <div className="bg-white rounded-2xl p-4 border border-neutral-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-neutral-500">Focus Time</span>
                    </div>
                    <p className="text-2xl font-bold text-neutral-900">{focusTimePercent}%</p>
                ...
                <div className="bg-white rounded-2xl p-4 border border-neutral-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-neutral-500">Avg Length</span>
                    </div>
                    <p className="text-2xl font-bold text-neutral-900">{avgMeetingLength}m</p>
                    <p className="text-xs text-neutral-400">per meeting</p>
                </div>
            </div>

            {/* Meeting Load Visualization */}
            <div className="bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm">
                <h3 className="text-lg font-bold text-neutral-900 mb-4">Weekly Meeting Load</h3>
                ...
                <div className="flex justify-between text-xs text-neutral-400 mb-6">
                    <span>0%</span>
                ...
                {/* Daily Breakdown */}
                <h4 className="text-sm font-medium text-neutral-500 mb-3">Daily Breakdown</h4>
                <div className="flex items-end justify-between h-32 gap-2">
                    {days.map((day, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="text-xs text-neutral-500">{hours}h</div>
                                <div
                                ...
                                />
                                <span className={`text-xs ${isSelected ? 'text-neutral-900 font-medium' : 'text-neutral-400'}`}>
                                    {day}
                                </span>
                            </div>
                        );
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white rounded-2xl p-5 border border-neutral-200 shadow-sm">
                    <h3 className="text-sm font-medium text-neutral-500 mb-4">Meeting Types</h3>
                        ...
                        {[
                            ...
                            <div key={item.type} className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-neutral-900">{item.type}</span>
                ...
                <div className="bg-white rounded-2xl p-5 border border-neutral-200 shadow-sm">
                    <h3 className="text-sm font-medium text-neutral-500 mb-4">Peak Times</h3>
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={item.time} className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-neutral-900">{item.time}</span>
            ...
            {pattern.alerts.length > 0 && (
                <div className="space-y-3">
                    <h3 className="text-sm font-medium text-neutral-500">Insights & Alerts</h3>
            ...
            <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                        <p className="font-medium text-neutral-900">Suggested Focus Blocks</p>
